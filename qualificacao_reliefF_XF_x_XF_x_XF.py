...
model_type_list = [['DenseNet169','MobileNet','ResNet50'],
                   ['DenseNet121','MobileNet','ResNet50'],['ResNet101','MobileNet','ResNet50'],
                   ['MobileNet','Xception','ResNet50'],['EfficientNetB0','MobileNet','ResNet50']]

model_type_list = [['DenseNet121','MobileNetV2','ResNet50']]
...
for model_type in model_type_list:
    ...
    #model 03
    features_model03, time_feature_extration03 = feature_model_extract(model_type[2])
    print('Extract features '+model_type[2]+' time feature extraction --> '+"{0:.4f}".format(time_feature_extration03) + " \n")
    
    number_features = number_features+np.shape(features_model03)[1]
    
    
    time_feature_extration = time_feature_extration01+time_feature_extration02+time_feature_extration03
    
    model_name = model_type[0]+"+"+model_type[1]+"+"+model_type[2]
    ...
    for model_dimension_reduction in model_reduction_dim_list:
        ...
        for index, [train, test] in enumerate(kf.split(df)):
            ...
            #model 03
            dataset_train_md03, dataset_train_label_md03, dataset_test_md03, dataset_test_label_md03 = gen_dataset(features_model03, labels, train, test) 
            ...
            #n better components for model 03
            print('Extract features '+model_type[2]+"_"+model_dimension_reduction+"_"+str(number_reduce_components)+'f')
            dataset_train_md03, dataset_test_md03, time_reduction_md03 = feature_selection(dataset_train_md03, dataset_train_label_md03, dataset_test_md03, model_dimension_reduction, number_reduce_components)
            
            #concat n features each model
            dataset_train = np.hstack((dataset_train_md01,dataset_train_md02,dataset_train_md03))
            dataset_test = np.hstack((dataset_test_md01,dataset_test_md02,dataset_test_md03))
            ...
            model_name = model_type[0]+"_"+str(number_reduce_components)+"f+"+model_type[1]+"_"+str(number_reduce_components)+"f+"+model_type[2]+"_"+str(number_reduce_components)+"f"
